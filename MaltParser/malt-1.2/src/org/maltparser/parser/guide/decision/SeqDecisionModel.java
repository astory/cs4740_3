...
public class SeqDecisionModel implements DecisionModel {
	...
	public SeqDecisionModel(Guide guide, FeatureModel featureModel) throws MaltChainedException {
	...
	public SeqDecisionModel(Guide guide, DecisionModel prevDecisionModel, String branchedDecisionSymbol) throws MaltChainedException {
