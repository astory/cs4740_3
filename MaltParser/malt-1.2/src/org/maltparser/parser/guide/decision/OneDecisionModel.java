...
public class OneDecisionModel implements DecisionModel {
	...
	public OneDecisionModel(Guide guide, FeatureModel featureModel) throws MaltChainedException {
	...
	public OneDecisionModel(Guide guide, DecisionModel prevDecisionModel, String branchedDecisionSymbol) throws MaltChainedException {
