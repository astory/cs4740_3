...
public class BranchedDecisionModel implements DecisionModel {
	...
	public BranchedDecisionModel(Guide guide, FeatureModel featureModel) throws MaltChainedException {
	...
	public BranchedDecisionModel(Guide guide, DecisionModel parentDecisionModel, String branchedDecisionSymbol) throws MaltChainedException {
	...
	public void noMoreInstances() throws MaltChainedException {
		if (guide.getGuideMode() != Guide.GuideMode.TRAIN) {
	...
	private DecisionModel initChildDecisionModel(SingleDecision decision, String branchedDecisionSymbol) throws MaltChainedException {
		...
		try {
			Class<?>[] argTypes = { org.maltparser.parser.guide.Guide.class, org.maltparser.parser.guide.decision.DecisionModel.class, 
