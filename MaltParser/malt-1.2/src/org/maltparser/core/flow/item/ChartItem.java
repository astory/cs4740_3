...
public abstract class ChartItem {
	 ...
	 * @throws MaltChainedException
	 */
	public abstract boolean preprocess() throws MaltChainedException;
	
	/**
	 * Cause the chart item to perform the process task (for every sentence)
	 * 
	 * @param continueNextSentence returned by the previous chart item
	 * @return true if it is ready to perform the next sentence, otherwise false
	 * @throws MaltChainedException
	 */
	public abstract boolean process(boolean continueNextSentence) throws MaltChainedException;
	 ...
	 * @throws MaltChainedException
	 */
	public abstract boolean postprocess() throws MaltChainedException;
