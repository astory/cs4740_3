...
the Naive Bayes classifier or the Decision Tree classifier and any combination of
features. On top of this we wrote bash scripts that automated
...
The NLTK implements a Naive Bayes classifier which chooses the best sense given a
...
%The negative interaction terms may indicate that the interacting
features provide similar functionality and blah blah blah
